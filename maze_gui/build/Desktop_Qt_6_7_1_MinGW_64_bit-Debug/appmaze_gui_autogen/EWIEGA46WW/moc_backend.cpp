...
void Backend::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->mazeDataChanged(); break;
        case 1: _t->generateMaze(); break;
        case 2: _t->findWay(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Backend::mazeDataChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->mazeColumns(); break;
        case 1: *reinterpret_cast< int*>(_v) = _t->mazeRows(); break;
        case 2: *reinterpret_cast< QStringList*>(_v) = _t->mazeData(); break;
        default: break;
        }
